% At the very top, before \documentclass
\PassOptionsToPackage{colorlinks=true, linkcolor=blue, urlcolor=cyan, citecolor=green}{hyperref}
...
\begin{wrapfigure}{l}{0.05\textwidth}
  \centering
  \includegraphics[width=0.075\textwidth]{juliahealth_logo_small.png}
\end{wrapfigure}
...
The community's packages are developed under the \href{https://github.com/JuliaHealth}{JuliaHealth GitHub organization} with additional community details at \href{https://juliahealth.org}{juliahealth.org}.
...
When external tools are needed, Julia can also reuse established biomedical software through interoperability packages such as PythonCall.jl \cite{PythonCall.jl} and RCall.jl \cite{randy_lai_2026_18422923}.
...
It solves the Bloch equations with configurable numerical accuracy and provides a flexible environment for designing and optimizing MRI pulse sequences, including optional physiological motion models. \cite{villacorta-aylagas_versatile_2025}
KomaMRI.jl has already been used for cardiac sequence optimization at low magnetic field strengths \cite{castillo-passi_highly_2025, paredes_simultaneous_2025}, synthetic dictionary generation for quantitative techniques \cite{pedraza_cardiac_2025}, evaluation of hardware imperfections \cite{zhang_data_}, and experimental imaging techniques for sensitively measuring oscillating magnetic currents in the brain \cite{gregersen_increasing_}.
...
For example, MedPipe3D.jl \cite{Mitura2021} orchestrates \href{https://github.com/JuliaHealth/MedImages.jl}{MedImages.jl}, MedEye3D.jl, and MedEval3D.jl into a workflow for data visualization, inspection, annotation, segmentation, and evaluation of 3D/4D images and other volumetric biomedical data (e.g., MRI, CT, PET).
Beyond orchestration, I/O packages such as \href{https://github.com/JuliaHealth/DICOM.jl}{DICOM.jl} support reading and writing Digital Imaging and Communications in Medicine (DICOM) images, metadata parsing, anonymization, and conversion to numerical arrays.
...
Packages like OMOPCDMCohortCreator.jl \cite{Zelko_OMOPCDMCohortCreator_0_2_0_2022}, \href{https://github.com/JuliaHealth/OMOPCommonDataModel.jl}{OMOPCommonDataModel.jl}, and \href{https://github.com/JuliaHealth/OHDSIAPI.jl}{OHDSIAPI.jl} assist researchers in defining patient populations, managing OMOP CDM data, and integrating with external OHDSI tools.
Furthermore, building on OMOP CDM databases, OMOPCDMPathways.jl \cite{OMOPCDMPathways.jl} maps and analyzes a patient's care continuum, while \href{https://github.com/JuliaHealth/OMOPCDMFeasibility.jl}{OMOPCDMFeasibility.jl} characterizes patient cohorts based on phenotype definitions and statistical profiles across covariates of interest.
Finally, \href{https://github.com/JuliaHealth/HealthBase.jl}{HealthBase.jl} provides templates for studies such as observational health studies and a common interface for packages to dispatch upon to bring unity to workflows across JuliaHealth.
...
For example, for simulation of biological and physiological processes, Thunderbolt.jl simulates cardiac electrophysiology and mechanics, and BloodFlowTrixi.jl can be used to explore hemodynamics. \cite{mannes2024derivation, mannes2024derivationPhD, ersoy2024new}
...
These tools support programmatic retrieval and analysis via packages such as \href{https://github.com/JuliaHealth/PubMedMiner.jl}{PubMedMiner.jl} for accessing literature from PubMed/MEDLINE and \href{https://github.com/JuliaHealth/PubChemCrawler.jl}{PubChemCrawler.jl} for retrieving chemical structures and properties from PubChem.
As JuliaHealth continues to grow, these efforts in simulation modeling and integration with bioinformatics resources will help expand JuliaHealth into new ecosystems and further stages of development. \cite{datseris2024physiological}
...
\begin{itemize}[label={\small\textbullet}, leftmargin=*, itemsep=4pt, labelsep=8pt]
...
\begin{itemize}[label={\small\textbullet}, leftmargin=*, itemsep=4pt, labelsep=8pt]
    ...
    \item Package development and planning on code hosting platforms such as the JuliaHealth GitHub.
    \item The \href{https://juliahealth.org/JuliaHealthBlog/}{JuliaHealth blog} to highlight ongoing work and community projects.
\end{itemize}
...
\begin{itemize}[label={\small\textbullet}, leftmargin=*, itemsep=4pt, labelsep=8pt]
    ...
    \item Interactive community dashboards with custom JuliaHealth modules to host and present analysis results.
